...
<div class="container mx-auto px-4 py-8">
            ...
            <div class="flex flex-wrap items-center gap-6 mb-6">
                ...
                <div class="flex items-center bg-white dark:bg-gray-800 p-3 rounded-lg shadow">
                    ...
                    <div>
                        ...
                        <div class="font-semibold">{{ number_format($manga['views']) }}</div>
                    </div>
                </div>
                ...
                <div class="flex items-center bg-white dark:bg-gray-800 p-3 rounded-lg shadow">
                    ...
                    <div>
                        ...
                        <div class="font-semibold">{{ $manga['chapter_count'] }}</div>
                    </div>
                </div>
            </div>
    ...
    <!-- Manga Tabs -->
    <div class="sticky top-0 z-10 bg-white dark:bg-gray-900 border-b border-gray-200 mb-6">
        <nav class="flex overflow-x-auto" x-data="{ activeTab: 'overview' }">
            <button 
                ...
                class="px-4 py-3 text-sm font-medium whitespace-nowrap focus:outline-none"
            >
                Visão Geral
            </button>
            <button 
                @click="activeTab = 'chapters'" 
                :class="{ 'border-b-2 border-blue-500 text-blue-600': activeTab === 'chapters' }"
                class="px-4 py-3 text-sm font-medium whitespace-nowrap focus:outline-none"
            >
            ...
            <button 
                ...
                :class="{ 'border-b-2 border-blue-500 text-blue-600': activeTab === 'recommendations' }"
                class="px-4 py-3 text-sm font-medium whitespace-nowrap focus:outline-none"
            >
                Recomendações
            </button>
                            ...
                            @for($i = 5; $i >= 1; $i--)
                                <div class="flex items-center mb-1">
                                    ...
                                    <div class="w-full bg-gray-200 rounded-full h-2.5 dark:bg-gray-700 mr-2">
                                        @php
                                            $percentage = isset($manga['rating_distribution'][$i]) ? ($manga['rating_distribution'][$i] / array_sum($manga['rating_distribution'])) * 100 : 0;
                                        @endphp
                        ...
                        <div class="flex items-center mb-4">
                            ...
                            <div class="ml-3">
                                ...
                                <div class="flex items-center">
                                    <div class="flex">
                                        @for($i = 1; $i <= 5; $i++)
                                            <svg class="w-4 h-4 {{ $i <= 4 ? 'text-yellow-400' : 'text-gray-300 dark:text-gray-600' }}" fill="currentColor" viewBox="0 0 20 20">
                                                <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                                            </svg>
                                        @endfor
                                    </div>
                                    <span class="text-xs text-gray-500 dark:text-gray-400 ml-2">2 dias atrás</span>
                                </div>
                            </div>
                        </div>
                        <h5 class="font-medium text-gray-900 dark:text-white mb-2">Excelente leitura!</h5>
            ...
            <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-4">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow overflow-hidden hover:shadow-md transition-shadow duration-200">
                    <div class="aspect-w-2 aspect-h-3 relative">
                        <div class="w-full h-64 bg-gray-200 dark:bg-gray-700 animate-pulse"></div>
                        <div class="absolute top-2 right-2 bg-yellow-500 text-white text-xs px-2 py-1 rounded">
                            9.5
                        </div>
                    </div>
                    <div class="p-3">
                        <h4 class="font-medium text-sm text-gray-900 dark:text-white line-clamp-2 mb-1">Título do Mangá Recomendado {{ $i + 1 }}</h4>
                        <p class="text-xs text-gray-500 dark:text-gray-400">Ação, Aventura</p>
                    </div>
                </div>
                @endfor
            </div>
