...
@section('header')
<h1 class="text-lg text-black-500">Editar Artista: {{ $artist->name }}</h1>
@endsection
        ...
        <form action="{{ route('admin.artists.update', $artist) }}" method="POST">
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <div class="mt-1">
                        <textarea name="description" id="description" rows="3" 
                                  class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 dark:bg-gray-700 dark:border-gray-600 dark:text-white rounded-md">{{ old('description', $artist->description) }}</textarea>
                    </div>
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <div class="mt-1 relative rounded-md shadow-sm">
                            ...
                            @php
                                $twitter = old('twitter', $artist->twitter);
                    ...
                    <div>
                        ...
                        <div class="mt-1">
                            <input type="text" name="pixiv" id="pixiv" value="{{ old('pixiv', $artist->pixiv) }}" 
                                   class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 dark:bg-gray-700 dark:border-gray-600 dark:text-white rounded-md"
                                   placeholder="1234567">
                        </div>
                ...
                <div id="other-links-container">
                    ...
                    <div id="link-fields">
                        @php
                            $otherLinks = old('other_links', $artist->other_links ?? []);
                            if (empty($otherLinks)) {
                                $otherLinks = [['name' => '', 'url' => '']];
                            }
                        @endphp
                        
                        @foreach ($otherLinks as $index => $link)
                        <div class="link-field mb-3 p-3 border border-gray-200 dark:border-gray-700 rounded-md">
                            <div class="grid grid-cols-1 md:grid-cols-12 gap-4">
                                <div class="md:col-span-5">
                                    <input type="text" name="other_links[{{ $index }}][name]" 
                                           value="{{ $link['name'] ?? '' }}"
                                ...
                                <div class="md:col-span-6">
                                    <input type="url" name="other_links[{{ $index }}][url]" 
                                           value="{{ $link['url'] ?? '' }}"
                ...
                <div class="flex justify-end space-x-3">
                    ...
                    <button type="submit" 
                        ...
                        <i class="fas fa-save mr-2"></i> Atualizar Artista
                    </button>
                </div>
            </div>
        </form>
