...
@section('title', 'Adicionar Novo Autor/Artista')

@section('header')
    <h1 class="text-lg text-black-500">Adicionar Novo Autor/Artista</h1>
...
@section('content')
    <div class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg overflow-hidden">
        <form action="{{ route('admin.authors.store') }}" method="POST" class="p-6">
            @csrf
